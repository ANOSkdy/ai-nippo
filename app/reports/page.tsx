...
export default async function ReportsPage({ searchParams }: { searchParams?: SearchParams }) {
  ...
  const totalMinutes = filteredRows.reduce((sum, row) => sum + row.minutes, 0);
            ...
            <table className="min-w-full divide-y divide-gray-200 overflow-hidden rounded-lg border border-gray-200">
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-start gap-2">
                          ...
                          {row.autoGenerated ? (
                            <span
                              className="badge-auto inline-flex items-center justify-center rounded-full border border-indigo-300 bg-indigo-50 px-2 py-0.5 text-[11px] font-medium text-indigo-700"
              ...
              <tfoot className="bg-gray-50">
                <tr className="text-sm text-gray-700">
                  ...
                  <td className="px-4 py-3">
                    <span>{formatWorkingHours(totalMinutes)}</span>
                    {autoCount > 0 ? (
                      <span className="ml-2 text-xs text-gray-500">（自動{autoCount}件）</span>
                    ) : null}
                  </td>
