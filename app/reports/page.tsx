...
export default async function ReportsPage({ searchParams }: { searchParams?: SearchParams }) {
  ...
  const totalWorkHours = sumWorkHours(filteredRows, (row) => formatWorkingHours(row.minutes));
  const totalWorkHoursText = formatTotalWorkHours(totalWorkHours);
