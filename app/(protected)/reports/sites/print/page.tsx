                      ...
                      return (
                        <tr key={`${row.date}-chunk-${chunkIndex}`}>
                          ...
                          {chunk.map(({ column, index }) => (
                            <td key={`${row.date}-print-${column.key}`} className="border px-2 py-1 text-right tabular-nums">
                  ...
                  <tfoot>
                    <tr className="bg-gray-100">
                      ...
                      {chunk.map(({ column }) => {
                        ...
                        return (
                          <td key={`print-total-${column.key}`} className="border px-2 py-1 text-right tabular-nums font-semibold">
