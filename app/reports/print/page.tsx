...
export default async function ReportsPrintPage({
  ...
  return (
    <main className="report-print mx-auto max-w-5xl space-y-3 p-4 text-[11px] leading-tight">
      <AutoPrintOnMount />
      ...
      {groups.length === 0 ? (
        ...
        <div className="space-y-3">
          {groups.map((group) => {
            ...
            return (
              <section key={group.key} className="space-y-2 rounded border border-gray-200 bg-white p-2">
                <div className="flex flex-wrap items-center gap-2 text-[11px] font-medium text-gray-800">
